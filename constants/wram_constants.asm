...
; wFollowerFlags::
FOLLOWER_SWAPPED_F   EQU 0
FOLLOWER_LOCK_SWAP_F EQU 1
FOLLOWER_FROZEN_F    EQU 2
...
; wStatusFlags2::
	...
	const STATUSFLAGS2_CAN_ENCOUNTER_MEW_F      ; 3
	const STATUSFLAGS2_BIKE_SHOP_CALL_F         ; 4
	const STATUSFLAGS2_CERULEAN_CAVE_UNLOCKED_F ; 5
