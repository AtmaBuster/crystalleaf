...
; Johto story events
	...
	const EVENT_GOT_GS_BALL_PHONE_CALL
	const EVENT_GOT_GS_BALL_FROM_ELM
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_BUG_CATCHER_HUEY
	const EVENT_BEAT_BUG_CATCHER_DEWEY
	const EVENT_BEAT_BUG_CATCHER_LOUIE
...
; Johto people
	...
	const EVENT_GOLD_KRIS_IN_MT_SILVER
...
; new itemballs
	const EVENT_CERULEAN_CAVE_1F_NUGGET_1
	const EVENT_CERULEAN_CAVE_1F_NUGGET_2
	const EVENT_CERULEAN_CAVE_1F_FULL_RESTORE_1
	const EVENT_CERULEAN_CAVE_1F_FULL_RESTORE_2
	const EVENT_CERULEAN_CAVE_1F_MAX_ELIXER_1
	const EVENT_CERULEAN_CAVE_1F_MAX_ELIXER_2
	const EVENT_CERULEAN_CAVE_1F_MAX_ELIXER_3
	const EVENT_CERULEAN_CAVE_1F_RARE_CANDY
	const EVENT_CERULEAN_CAVE_1F_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_1F_MAX_REVIVE
	const EVENT_CERULEAN_CAVE_2F_FULL_RESTORE_1
	const EVENT_CERULEAN_CAVE_2F_FULL_RESTORE_2
	const EVENT_CERULEAN_CAVE_2F_FULL_RESTORE_3
	const EVENT_CERULEAN_CAVE_2F_ULTRA_BALL_1
	const EVENT_CERULEAN_CAVE_2F_ULTRA_BALL_2
	const EVENT_CERULEAN_CAVE_2F_ULTRA_BALL_3
	const EVENT_CERULEAN_CAVE_2F_PP_UP_1
	const EVENT_CERULEAN_CAVE_2F_PP_UP_2
	...
	const EVENT_CERULEAN_CAVE_B1F_ULTRA_BALL_3
	const EVENT_CERULEAN_CAVE_B1F_ULTRA_BALL_4
	const EVENT_CERULEAN_CAVE_B1F_MAX_REVIVE_1
	const EVENT_CERULEAN_CAVE_B1F_MAX_REVIVE_2
	const EVENT_CERULEAN_CAVE_B1F_MAX_REVIVE_3
