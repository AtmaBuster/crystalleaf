...
Route2_MapEvents:
	...
	warp_event  3,  9, VIRIDIAN_FOREST_GATE_NORTH, 1
	warp_event  4,  9, VIRIDIAN_FOREST_GATE_NORTH, 2
	warp_event  5, 31, VIRIDIAN_FOREST_GATE_SOUTH, 3
	...
	object_event 14, 12, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
