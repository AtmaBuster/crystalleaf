...
TrainerSailorHuey:
	trainer SAILOR, BART1, EVENT_BEAT_SAILOR_HUEY, SailorHueySeenText, SailorHueyBeatenText, 0, .Script
...
.AskForNumber:
	...
	gettrainername STRING_BUFFER_3, SAILOR, BART1
