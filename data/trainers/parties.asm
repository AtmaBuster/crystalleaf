...
GoldNPCGroup:
	; GOLD
	db "GOLD@", TRAINERTYPE_MOVES
	db 81, TYPHLOSION, FLAMETHROWER, STRENGTH, FIRE_PUNCH, SMOKESCREEN
	db 81, FERALIGATR, WATERFALL, SLASH, SCARY_FACE, RAIN_DANCE
	db 75, UMBREON,    FAINT_ATTACK, MOONLIGHT, MEAN_LOOK, RETURN
	db 77, DONPHAN,    EARTHQUAKE, ROLLOUT, RAPID_SPIN, DEFENSE_CURL
	db 77, SLOWKING,   CURSE, DISABLE, SWAGGER, PSYCHIC_M
	db 73, HO_OH,      SACRED_FIRE, FLY, ANCIENTPOWER, FUTURE_SIGHT
	db -1 ; end

KrisNPCGroup:
	; KRIS
	db "KRIS@", TRAINERTYPE_MOVES
	db 81, MEGANIUM,   RAZOR_LEAF, POISONPOWDER, SUNNY_DAY, SOLARBEAM
	db 81, AMPHAROS,   THUNDERBOLT, ZAP_CANNON, COTTON_SPORE, FLASH
	db 75, ESPEON,     PSYCHIC_M, MORNING_SUN, QUICK_ATTACK, RETURN
	db 77, POLITOED,   REST, SNORE, SURF, PERISH_SONG
	db 77, HOUNDOOM,   FLAMETHROWER, CRUNCH, ROAR, SLUDGE_BOMB
	db 73, LUGIA,      AEROBLAST, HYDRO_PUMP, RECOVER, SAFEGUARD
	db -1 ; end
